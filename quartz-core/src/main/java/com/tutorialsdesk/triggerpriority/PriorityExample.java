package com.tutorialsdesk.triggerpriority;
...
import com.tutorialsdesk.job.HelloJob;
...
public class PriorityExample {
	...
	public void run() throws Exception {
		...
		JobDetail job = newJob(HelloJob.class).withIdentity("TriggerEchoJob").build();
		...
		// Second trigger has default priority of 5 (default), and will repeat after 10
		// seconds
