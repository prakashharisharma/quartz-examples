package com.tutorialsdesk.highload;
...
import com.tutorialsdesk.job.SimpleJob;
...
public class LoadExample {
  ...
  public void run() throws Exception {
    ...
    for (int count = 1; count <= _numberOfJobs; count++) {
      JobDetail job = newJob(SimpleJob.class).withIdentity("job" + count, "group_1").requestRecovery() // ask scheduler                                                                                          // went down...
          .build();
