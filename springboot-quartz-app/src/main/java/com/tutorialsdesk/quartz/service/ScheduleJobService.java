package com.tutorialsdesk.quartz.service;
...
import com.tutorialsdesk.quartz.job.QuartzJobFactory;
...
public class ScheduleJobService {
    ...
    private void addJob(ScheduleJob scheduleJob) throws Exception{  
    	...
    	System.out.println("ScheduleJobService.addJob()" + scheduleJob.getCronExpression());
        ...
        if(!scheduleJob.getCronExpression().isEmpty()) {
            ...
            Trigger simpleTrigger = createSingleTrigger(triggerKey.getName(), startTime, SimpleTrigger.MISFIRE_INSTRUCTION_FIRE_NOW);
	...
	private Trigger createSingleTrigger(String triggerName, Date startTime, int misFireInstruction){
